...
class ChromeCastControlsUIViewController: UIViewController, PlayerConfigurable {

    var jsonUrl: String = "https://demo.bbvms.com/p/default/c/4339066.json"
    var playerOptions: [String: Any] = [:]
    
    var defaultJsonUrl: String {
        return "https://demo.bbvms.com/p/default/c/4339066.json"
    }
    ...
    var alertTitle: String {
        return "Enter ChromeCast Controls demo configuration"
    }
